...
{#if $toast.active && $toast.type === 'success'}
<div id="toast-success" class="toast flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert"  transition:fade>
...
{#if $toast.active && $toast.type === 'info'}
<div id="toast-success" class="toast flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert"  transition:fade>
...
{#if $toast.active && $toast.type === 'error'}
<div id="toast-danger" class="toast flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
...
{#if $toast.active && $toast.type === 'warning'}
<div transition:fade id="toast-warning" class="toast flex items-center p-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
